...
const Searchbar = () => {
  ...
  return (
    <>
      <motion.form action="#" className={`header__form ${isMobile ? 'header__form--active' : ''}`}>
        <motion.input
          className="header__form-input"
          type="text"
          placeholder="I'm looking for..."
        />
        <motion.button className="header__form-btn" type="button">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path d="M21.71,20.29,18,16.61A9,9,0,1,0,16.61,18l3.68,3.68a1,1,0,0,0,1.42,0A1,1,0,0,0,21.71,20.29ZM11,18a7,7,0,1,1,7-7A7,7,0,0,1,11,18Z" />
          </svg>
        </motion.button>
        <motion.button type="button" className="header__form-close" onClick={() => setIsMobile(false)}>
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
      ...
      <motion.button className="header__search" type="button" onClick={() => isMobile ? setIsMobile(false) : setIsMobile(true)}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path d="M21.71,20.29,18,16.61A9,9,0,1,0,16.61,18l3.68,3.68a1,1,0,0,0,1.42,0A1,1,0,0,0,21.71,20.29ZM11,18a7,7,0,1,1,7-7A7,7,0,0,1,11,18Z" />
        </svg>
      </motion.button>
