...
const SignIn = () => {
  ...
  return ( 
    ...
    >
      ...
      <motion.div className="sign__social">
        <motion.a
          className={`fb ${isLoading && "loading"}`}
          href="#"
          variants={authFadeInUpVariants}
        ...
        <motion.a className={`tw ${isLoading && "loading"}`}
          variants={authFadeInUpVariants}
          href="#"
          onClick={() => dispatch(twitterSignInStart())}
          disabled={isLoading}>
          {!isLoading && (
            <svg
            viewBox="0 0 16 12"
        ...
        <motion.a
          className={`gl ${isLoading && "loading"}`}
          variants={authFadeInUpVariants}
          href="#"
